              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="What will participants learn from this field trip?"
                    rows={4}
                  />
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <Button type="button" variant="outline" asChild>
                    <Link href="/staff/field-trips">Cancel</Link>
                  </Button>
                </div>
              </form>
            </CardContent>
